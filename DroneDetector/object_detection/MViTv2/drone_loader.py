...
drone_dataset = DroneDataset(label_dir, img_dir)
metadata = drone_dataset.drone_dataset_metadata()

dataloader = OmegaConf.create()

dataloader.train = L(build_detection_train_loader)(
    dataset=L(get_detection_dataset_dicts)(names="drone_dataset_train"),
...
dataloader.test = L(build_detection_test_loader)(
    dataset=L(get_detection_dataset_dicts)(names="drone_dataset_val", filter_empty=False),
    mapper=L(DatasetMapper)(
        is_train=False,
        augmentations=[
