...
sys.path.append("../..")
from object_detection.maskRCNN.config import infer_setup
...
def get_sample_inputs(cfg):
    # get a sample data
    original_image = detection_utils.read_image("/Users/youssefoumate/DL/DroneDetector/dataset/images/video18_2090.JPEG", "RGB")
...
if __name__ == "__main__":
    ...
    if args.export_method == "caffe2_tracing":
        sample_inputs = get_sample_inputs(cfg)
